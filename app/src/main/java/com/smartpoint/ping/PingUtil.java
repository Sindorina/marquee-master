...
public class PingUtil {
     ...
     * @return 最大RTT值，单位 ms 注意：-1是默认值，返回-1表示获取失败
     */
    public static int getMaxRTT(String domain, int count, int timeout) {
     ...
     * @param count 需要ping的次数 *
     * @param timeout 需要ping的超时时间，单位ms *
     * @return RTT 平均偏差，单位 ms 注意：-1是默认值，返回-1表示获取失败
     */
     ...
     * @param url 需要ping的url地址 *
     * @param count 需要ping的次数 *
     * @param timeout 需要ping的超时时间，单位 ms * @return 丢包率 如50%可得 50，注意：-1是默认值，返回-1表示获取失败
     */
