...
public class CodeUtils {
    ...
    //public static final int ONE_COLOR = 0x9932CC;
    private static int ONE_COLOR = 0xff000000;
    private static int TWO_COLOR = 0xffffffff;

    public static final String LAYOUT_ID = "layout_id";

    public static void setBmpOneColor(int color) {
        ONE_COLOR = color;
    }
            ...
            for (int y = 0; y < h; y++) {
                for (int x = 0; x < w; x++) {
                    if(x >= offsetX && x < offsetX + scaleWidth && y>= offsetY && y < offsetY + scaleHeight){
                        ...
                        if (bitMatrix.get(x, y)) {
                            pixels[y * w + x] = ONE_COLOR;
                        } else {
                            pixels[y * w + x] = TWO_COLOR;
                        }
                    }
                }
            }
